...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2025 at 12:49 AM
...
(101, 'FNKJANCJ', '2025-05-08', '10:00:00');
...
(3, 'ivan69', '$2a$11$PRDfVUYIuU.ZZp7jrohCJe/MwawKdMNs7mInpRJjbO2ztsXXCxIO2', 'user', 1, '2025-05-07 22:35:51'),
(4, 'maybelene21', '$2a$11$YuLgehswawhfFcGsazrVv.PMw0PSrptbN61mCV3F.fujPRJ9VrLUe', 'user', 1, '2025-05-07 22:37:01'),
(5, 'cris00', '$2a$11$i4nJPaHv4sQbTDqL3DY0be.Bv4tbWO84m0JdbkqxNcTkWWj20H65u', 'user', 1, '2025-05-07 22:37:33'),
(6, 'ace96', '$2a$11$qJ3Bfin8Hy5jjxjfooBdp.9wQNfQACjh1BHdoLwDt.Po9YHAnJXcm', 'user', 1, '2025-05-07 22:38:34');
...
--
ALTER TABLE `return_flights`
  MODIFY `return_flight_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
